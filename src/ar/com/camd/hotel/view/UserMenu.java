...
public class UserMenu extends JFrame {
	...
	public UserMenu() {
		...
		labelRegistro.setIcon(new ImageIcon(UserMenu.class.getResource("../img/reservado.png")));
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				FindGuestReservation busqueda = new FindGuestReservation();
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(UserMenu.class.getResource("../img/pessoas.png")));
