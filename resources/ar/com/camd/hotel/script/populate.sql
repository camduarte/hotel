...
DELETE FROM hotel.reserve;
DELETE FROM hotel.employee;

INSERT INTO hotel.reserve (checkin_date, checkout_date, value, payment_method) VALUES
...
INSERT INTO hotel.guest (name, lastname, birthdate, nationality, phone_number, id_reserve) VALUES
...
INSERT INTO hotel.employee (name, lastname, email, password) VALUES
